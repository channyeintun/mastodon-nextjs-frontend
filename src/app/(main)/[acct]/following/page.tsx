            ...
            <VirtualizedList<Account>
                ...
                renderItem={(followedAccount) => (
                    <AccountCard
                        ...
                        relationship={relationshipMap[followedAccount.id]}
                        showFollowButton
                ...
                endIndicator={t('followingPage.noMoreAccounts')}
                emptyState={
                    account.following_count > 0 ? (
                        <EmptyState title={t('followingPage.hiddenInfo')} />
                    ) : (
                        <EmptyState title={t('followingPage.notFollowingYet')} />
                    )
                }
            />
        </div>
