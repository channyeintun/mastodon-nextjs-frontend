...
interface UseWindowScrollDirectionOptions {
    /**
...
interface UseWindowScrollDirectionResult {
    /**
...
export function useWindowScrollDirection(
    options: UseWindowScrollDirectionOptions = {}
): UseWindowScrollDirectionResult {
